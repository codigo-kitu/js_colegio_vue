...
const nuevoDatos = async () => {		
	...
	var form_json:MateriaParamCreate = {
		created_at : materia.value.created_at,
		updated_at : materia.value.updated_at,
		codigo : materia.value.codigo,
		nombre : materia.value.nombre,
		activo : materia.value.activo,
	};
