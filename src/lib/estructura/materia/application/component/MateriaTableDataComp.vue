...
import MateriaTableRowDataComp from '@/lib/estructura/materia/application/component/MateriaTableRowDataComp.vue';
...
const handleAction_ClickTableRowTableView = async (materia1: Materia) => {		
	...
	emit('handleAction_ClickTableRowView',materia1);
};
	...
	<div id="div_materia_tabla_general">					
		...
		<table id="materia_tabla_general" 
			...
			<tbody>
				...
				<MateriaTableRowDataComp v-for="materia1 in materias" 
					:module="module"
