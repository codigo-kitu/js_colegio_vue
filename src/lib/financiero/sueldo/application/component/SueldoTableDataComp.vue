...
import SueldoTableRowDataComp from '@/lib/financiero/sueldo/application/component/SueldoTableRowDataComp.vue';
...
//------------------ GENERAL --------------------
let title = ref('Tabla Datos Sueldo');
...
const handleAction_ClickTableRowTableView = async (sueldo1: Sueldo) => {		
	...
	emit('handleAction_ClickTableRowView',sueldo1);
};
...
<div id="divCompGlobalTablasueldo">
	...
	<div id="div_sueldo_tabla_general">					
		...
		<input type="hidden" id="sueldo_tabla_general_length" name="sueldo_tabla_general_length" 
				value="{{= sueldo_parametro_view.sueldos.length }}" />
		
		<table id="sueldo_tabla_general" 
				class="table_general">
			...
			<tbody>
				...
				<SueldoTableRowDataComp v-for="sueldo1 in sueldos" 
					:module="module"
	...
	<div id="div_sueldo_pagination_form_general">
		...
		<form id="sueldo_pagination_form_general" class="pagination_form_general">							
	...
	<div id="div_sueldo_actions_general">
		...
		<form id="sueldo_actions_general" class="actions_form_general">
